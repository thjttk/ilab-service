...
angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html","template/accordion/accordion.html","template/alert/alert.html","template/carousel/carousel.html","template/carousel/slide.html","template/datepicker/datepicker.html","template/datepicker/day.html","template/datepicker/month.html","template/datepicker/popup.html","template/datepicker/year.html","template/modal/backdrop.html","template/modal/window.html","template/pagination/pager.html","template/pagination/pagination.html","template/tooltip/tooltip-html-unsafe-popup.html","template/tooltip/tooltip-popup.html","template/popover/popover.html","template/progressbar/bar.html","template/progressbar/progress.html","template/progressbar/progressbar.html","template/rating/rating.html","template/tabs/tab.html","template/tabs/tabset.html","template/timepicker/timepicker.html","template/typeahead/typeahead-match.html","template/typeahead/typeahead-popup.html","template/tabs/tabset-btn.html","template/tabs/tabset-grey.html"]);
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: function(ele, attr){
      if(attr.type == 'button'){
        return 'template/tabs/tabset-btn.html';
      }else if(attr.type == ''){
        return 'template/tabs/tabset.html';
      }else if(attr.type == 'grey'){
        return 'template/tabs/tabset-grey.html';
      }
      else{
        return 'template/tabs/tabset.html';
      }
...
angular.module("template/tabs/tabset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tabset.html",
    "\n" +
    "<div class=\"intel-tab\">\n" +
    "  <ul ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\" ng-transclude></ul>\n" +
...
/*for btn type tabs, eg:config vm*/
angular.module("template/tabs/tabset-btn.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tabset-btn.html",
    "\n" +
    "<div class=\"intel-btn-tab\">\n" +
    "<div>\n" +
    "  <ul ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\" ng-transclude></ul>\n" +
...
/*for nested type tabs, eg: add from vm template */
angular.module("template/tabs/tabset-grey.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tabset-grey.html",
    "\n" +
    "<div class=\"intel-grey-tab\">\n" +
    "  <ul ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\" ng-transclude></ul>\n" +
    "    <hr class=\"intel-tab-divider\">"  +
    "  <div class=\"intel-tab-content\">\n" +
    "    <div class=\"tab-pane\" \n" +
...
angular.module("template/typeahead/typeahead-popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead-popup.html",
    "<ul class=\"content\" ng-if=\"isOpen()\" ng-style=\"{top: position.top+'px', left: position.left+'px'}\" style=\"display: block;\" role=\"listbox\" aria-hidden=\"{{!isOpen()}}\">\n" +
...
angular.module("template/datepicker/day.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("template/datepicker/day.html",
            ...
            "  <thead>\n" +
            "    <tr>\n" +
            "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left\" ng-click=\"move(-1)\" tabindex=\"-1\"><i class=\"glyphicon intelicon-left-previous\"></i></button></th>\n" +
            "      <th colspan=\"{{5 + showWeeks}}\"><button id=\"{{uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" aria-atomic=\"true\" type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"toggleMode()\" tabindex=\"-1\" style=\"width:100%;\"><strong>{{title}}</strong></button></th>\n" +
            "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-right\" ng-click=\"move(1)\" tabindex=\"-1\"><i class=\"glyphicon intelicon-right-next\"></i></button></th>\n" +
            "    </tr>\n" +
            "    <tr>\n" +
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("template/datepicker/popup.html",
            "<ul class=\"date-dropdown-menu\" ng-style=\"{display: (isOpen && 'block') || 'none', top: position.top+'px', left: position.left+'px'}\" ng-keydown=\"keydown($event)\">\n" +
            " <li ng-transclude></li>\n" +
